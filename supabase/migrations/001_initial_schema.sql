...
DROP POLICY IF EXISTS "Public can read CatStays media" ON storage.objects;
CREATE POLICY "Public can read CatStays media" ON storage.objects
  FOR SELECT USING (bucket_id = 'catstays-media');
