            ...
            <>
              ...
              <div className="space-y-3 text-sm text-[#0A1128]">
                ...
                {editorMode === 'move' && <div className="space-y-3 rounded-xl bg-[#F8F7F5] p-3">
                  <label className="block text-xs font-semibold uppercase text-[#4E5871]">New arrival date<input type="date" value={moveDraft.checkIn} onInput={(event) => setMoveDraft((current) => ({ ...current, checkIn: event.currentTarget.value }))} className="mt-1 h-11 w-full rounded-lg border border-[#D8D2CB] bg-white px-3 text-sm font-normal text-[#0A1128]" /></label>
                ...
                {editorMode === 'split' && <div className="space-y-3 rounded-xl bg-[#F8F7F5] p-3">
                  ...
                  <label className="block text-xs font-semibold uppercase text-[#4E5871]">Move to second room on<input type="date" min={addDateKey(selected.booking.check_in, 1)} max={selected.booking.check_out} value={splitDraft.secondStartsOn} onInput={(event) => setSplitDraft((current) => ({ ...current, secondStartsOn: event.currentTarget.value }))} className="mt-1 h-11 w-full rounded-lg border border-[#D8D2CB] bg-white px-3 text-sm font-normal text-[#0A1128]" /></label>
